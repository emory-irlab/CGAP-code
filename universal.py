...
PARAM_FOLDER_SEEDWORDS: str = "folder_seedwords"
PARAM_FOLDER_SEEDWORDS_GOOGLE: str = "folder_seedwords_google"
...
with open(f"{UNIVERSAL}{HYPHEN}{PARAMETERS}{JSON}") as universal_json_file:
	...
	FOLDER_SEEDWORDS: str = universal_parameters[PARAM_FOLDER_SEEDWORDS]
	FOLDER_SEEDWORDS_GOOGLE = universal_parameters[PARAM_FOLDER_SEEDWORDS_GOOGLE]
