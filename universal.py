...
DEFAULT_POLLUTANTS: Dict[str, dict] = {
	...
	DEPT: {
		...
		EPA_FILTER: {
			...
			# EPA_COLUMN_SAMPLE_DURATION: "1 HOUR", todo figure out what the sample durations are
		},
	},
	NO2: {
	...
	RHUM: {
		...
		EPA_FILTER: {
			...
			# EPA_COLUMN_SAMPLE_DURATION: "24 HOUR", todo - figure out
		},
	},
	SO2: {
	...
	TEMPO: {
		...
		EPA_FILTER: {
			...
			# EPA_COLUMN_SAMPLE_DURATION: "1 HOUR", todo
		},
	},
}
